...
public class ResourceListController {
	...
	private void populateDvdListTable() {
		...
		titleDvd.setCellValueFactory(new PropertyValueFactory<Dvd, String>("title"));
		yearDvd.setCellValueFactory(new PropertyValueFactory<Dvd, Integer>("year"));
		detailsDvd
				.setCellFactory(ActionButtonTableCell.<Dvd>forTableColumn("Edit", (Dvd d) -> loadDvdResourceDetail(d)));
	...
	private void populateLaptopListTable() {
		...
		// resourceID.setCellValueFactory(new
		// PropertyValueFactory<Resource, Integer>("resourceID"));
		titleLaptop.setCellValueFactory(new PropertyValueFactory<Laptop, String>("title"));
		yearLaptop.setCellValueFactory(new PropertyValueFactory<Laptop, Integer>("year"));
		detailsLaptop.setCellFactory(
				ActionButtonTableCell.<Laptop>forTableColumn("Edit", (Laptop l) -> this.loadLaptopResourceDetail(l)));
	...
	private void populateBookListTable() {
		...
		detailsBook.setCellFactory(
				ActionButtonTableCell.<Book>forTableColumn("Edit", (Book b) -> this.loadBookResourceDetail(b)));
